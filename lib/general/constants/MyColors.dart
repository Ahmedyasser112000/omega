...
class MyColors{
  static Color primary =  Color(0xff0A837A);
  static Color secondary =  Color(0xffEE8322);
  static Color third =  Color(0xff002B41);
  static Color forth =  Color(0xff4495BF);
  static Color headerColor =  Color(0xffA2A2A2);
  ...
  // static Color buttonColor=Color(0xff02BAAE4F);
